...
package com.yiranpay.reconciliation.utils;
 ...
 * 日期工具类
 */
public class ReconciliationDateUtils  {
	...
	private static Log logger = LogFactory.getLog(ReconciliationDateUtils.class);
	...
	public static SimpleDateFormat sdfDateTime = new SimpleDateFormat(ReconciliationDateUtils.DATE_FORMAT_DATETIME);
	// Global SimpleDateFormat object
	public static SimpleDateFormat sdfDateOnly = new SimpleDateFormat(ReconciliationDateUtils.DATE_FORMAT_DATEONLY);
	...
	public static Timestamp toSqlTimestamp(String sDate) {
		...
		if (sDate.length() != ReconciliationDateUtils.DATE_FORMAT_DATEONLY.length()
				&&sDate.length() != ReconciliationDateUtils.DATE_FORMAT_DATETIME.length()) {
			return null;
		}
		return toSqlTimestamp(sDate,
				sDate.length() == ReconciliationDateUtils.DATE_FORMAT_DATEONLY.length()
				? ReconciliationDateUtils.DATE_FORMAT_DATEONLY
				: ReconciliationDateUtils.DATE_FORMAT_DATETIME);
	...
	public static Timestamp toSqlTimestamp(String sDate, String sFmt) {
		...
		if (sFmt.equals(ReconciliationDateUtils.DATE_FORMAT_DATETIME)) {
			temp = sDate.replace('/', '-');
			temp = temp + ".000000000";
		} else if (sFmt.equals(ReconciliationDateUtils.DATE_FORMAT_DATEONLY)) {
			temp = sDate.replace('/', '-');
	...
	public static String getSysDateTimeString() {
		return toString(new Date(System.currentTimeMillis()), ReconciliationDateUtils.sdfDateTime);
	}
	...
	public static String toSqlTimestampString2(Timestamp dt) {
		...
		String temp = toSqlTimestampString(dt, ReconciliationDateUtils.DATE_FORMAT_DATETIME);
	...
	public static String toSqlTimestampString(Timestamp dt, String sFmt) {
		...
		temp = dt.toString();
		if (sFmt.equals(ReconciliationDateUtils.DATE_FORMAT_DATETIME) || // "YYYY/MM/DD
				// HH24:MI:SS"
				sFmt.equals(ReconciliationDateUtils.DATE_FORMAT_DATEONLY)) { // YYYY/MM/DD
	...
	public static String timestampToStringYMD(Timestamp timestamp) {
		SimpleDateFormat sdf = new SimpleDateFormat(ReconciliationDateUtils.DATE_FORMAT_DATEONLY);
	...
	public static boolean isOverIntervalLimit(String startDateStr, String endDateStr, int interval) {
		Date startDate = null;
		Date endDate = null;
		startDate = ReconciliationDateUtils.parseDate(startDateStr, ReconciliationDateUtils.DATE_FORMAT_DATEONLY);
		endDate = ReconciliationDateUtils.parseDate(endDateStr, ReconciliationDateUtils.DATE_FORMAT_DATEONLY);
	...
	public static Date getMaxTime(Date dt) {
		...
		dt1 = ca.getTime();
		dt1 = ReconciliationDateUtils.getMinTime(dt1);
		ca.setTime(dt1);
	...
	public static Date getMinTime(Date dt) {
		Date dt1 = null;
		dt1 = ReconciliationDateUtils.getDateByStr(ReconciliationDateUtils.formatDate(dt, "yyyy-MM-dd"));
		return dt1;
	}
	...
	public static List<String> getLastDays(int countDay) {
		...
		for (int i = 0; i < countDay; i++) {
			listDate.add(ReconciliationDateUtils.getReqDateyyyyMMdd(ReconciliationDateUtils.getDate(-i)));
		}
		return listDate;
	}
