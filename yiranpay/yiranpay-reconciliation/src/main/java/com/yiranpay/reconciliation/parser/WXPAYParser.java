...
import com.yiranpay.reconciliation.utils.XmlUtils;
 ...
 * 微信对账单解析器 .
 */
@Component("WXPAYParser")
public class WXPAYParser implements ParserInterface {

	private static final Log LOG = LogFactory.getLog(WXPAYParser.class);
	 ...
	 * @return
	 */
	public List<ReconciliationEntityVo> parser(File file, Date billDate, ReconciliationAccountCheckBatch batch) {
	 ...
	 * @return
	 */
	private List<ReconciliationEntityVo> parseSuccess(List<String> list, String billDate, ReconciliationAccountCheckBatch batch) {
	 ...
	 *            对账批次记录
	 */
	public void isError(File file, ReconciliationAccountCheckBatch batch) {
