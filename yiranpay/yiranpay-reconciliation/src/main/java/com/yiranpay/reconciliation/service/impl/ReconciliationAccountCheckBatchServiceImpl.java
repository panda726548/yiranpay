...
import com.yiranpay.reconciliation.mapper.ReconciliationAccountCheckBatchMapper;
...
public class ReconciliationAccountCheckBatchServiceImpl implements IReconciliationAccountCheckBatchService 
{
	...
	@Override
	public List<ReconciliationAccountCheckBatch> selectSuccessBatchList(Map<String, Object> paramMap) {
		return reconciliationAccountCheckBatchMapper.selectSuccessBatchList(paramMap);
	}
