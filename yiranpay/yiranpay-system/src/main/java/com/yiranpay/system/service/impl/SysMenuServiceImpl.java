...
import com.yiranpay.system.domain.SysMenu;
import com.yiranpay.system.domain.SysRole;
import com.yiranpay.system.domain.SysUser;
import com.yiranpay.system.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService
{
    ...
    public LinkedHashMap<String, String> selectPermsAll(Long userId)
    {
        ...
        if (StrUtils.isNotEmpty(permissions))
        {
    ...
    {
        List<Ztree> ztrees = new ArrayList<Ztree>();
        boolean isCheck = StrUtils.isNotNull(roleMenuList);
    ...
    {
        Long menuId = StrUtils.isNull(menu.getMenuId()) ? -1L : menu.getMenuId();
        SysMenu info = menuMapper.checkMenuNameUnique(menu.getMenuName(), menu.getParentId());
        if (StrUtils.isNotNull(info) && info.getMenuId().longValue() != menuId.longValue())
        {
