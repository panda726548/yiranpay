...
public class BankAcctDomainUtil {
    ...
    public static boolean isQueryMemberBank(MemberTrBankAccount bank) {
        if (StringUtils.isNotEmpty(bank.getMemberId()) && bank.getStatus() == null) {

            if (StringUtils.isNotEmpty(bank.getBankAccountNo())) {
                return false;
            }
            ...
            if (StringUtils.isNotEmpty(bank.getIsSigning())) {
                return false;
            }
    ...
    public static List<MemberTrBankAccount> filterBankAccount(List<MemberTrBankAccount> banks, MemberTrBankAccount query) {
        ...
        for (MemberTrBankAccount item : banks) {
            if (StringUtils.isNotEmpty(query.getBankAccountNo())) {
            ...
            if (StringUtils.isNotEmpty(query.getIsSigning())) {
