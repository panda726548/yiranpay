...
public class ContactFacadeValidator {
    ...
    private static void checkContactName(String contactName, boolean isMust) {
        if (isMust && StringUtils.isEmpty(contactName)) {
    ...
    private static void validatorBody(MemberTmContact contact) {
         ...
         * 判断非必填字段的长度
         */
        if (!StringUtils.isEmpty(contact.getTown())
        ...
        if (!StringUtils.isEmpty(contact.getPostcode())
        ...
        if (!StringUtils.isEmpty(contact.getWebsite())
        ...
        if (!StringUtils.isEmpty(contact.getPosition())
        ...
        if (!StringUtils.isEmpty(contact.getProvince())
