...
public class MemberTmMember extends BaseEntity
{
    ...
    public BasicAccountType getBaseAccountType() {
    	if(MemberTypeEnum.SPECIAL.equals(getMemberType())){
            return BasicAccountType.SPECIAL_BASIC_ACCOUNT;
        }else if(MemberTypeEnum.VIRTUAL.equals(getMemberType())){
        	return BasicAccountType.SPECIAL_BASIC_ACCOUNT;
        }
        return BasicAccountType.COMPANY_BASIC_ACCOUNT;
    }
