...
public class SysNoticeController extends BaseController
{
    ...
    @PostMapping("publish")
    @ResponseBody
    public AjaxResult publish(SysNotice notice){
        notice.setUpdateBy(ShiroUtils.getLoginName());
        notice.setPublishDate(DateUtils.getDate());
        return toAjax(noticeService.publish(notice));
    }

    @GetMapping("preview/{noticeId}")
    public String preview(@PathVariable("noticeId") Long noticeId,ModelMap modelMap){
