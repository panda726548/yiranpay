...
import com.yiranpay.payorder.request.CreatOrderForm;
...
import com.yiranpay.framework.web.domain.PayFundResponse;
...
public class PayTestController extends BaseController
{
	...
	{		
		...
		ext.add("PAGE_URL", "");
		ext.add("payType", "NATIVE");
		ext.add("PAGE_URL", "http://127.0.0.1:8087/api/yiranpay/channelpay/notify/resultNotify");
