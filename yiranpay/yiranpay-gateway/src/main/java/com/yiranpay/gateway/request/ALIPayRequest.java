 ...
 *
 */
public class ALIPayRequest extends RequestBase {
	...
	/**
	 * 支付类型  PC端支付PAGE_PAY  手机端WAP_WAY   APP应用APP_PAY
	 */
	...
	public String toString() {
		return "ALIPayRequest [requestNo=" + requestNo + ", amount=" + amount + ", productName=" + productName
