package com.yiranpay.framework.aspectj;
...
import com.yiranpay.common.enums.BusinessStatus;
import com.yiranpay.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.yiranpay.common.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            if (currentUser != null)
            {
                ...
                if (StrUtils.isNotNull(currentUser.getDept())
                        && StrUtils.isNotEmpty(currentUser.getDept().getDeptName()))
                {
            ...
            if (e != null)
            {
                ...
                operLog.setErrorMsg(StrUtils.substring(e.getMessage(), 0, 2000));
            }
            // 设置方法名称
