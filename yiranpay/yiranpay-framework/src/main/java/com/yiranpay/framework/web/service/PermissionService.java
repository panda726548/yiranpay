package com.yiranpay.framework.web.service;
...
/**
 * yiranpay首创 js调用 thymeleaf 实现按钮权限可见性
 * 
 * @author yiranpay
 */
@Service("permission")
public class PermissionService
{
    ...
    {
        return isPermitted(permission) ? StrUtils.EMPTY : NOACCESS;
    }
    ...
    {
        return isLacksPermitted(permission) ? StrUtils.EMPTY : NOACCESS;
    }
    ...
    {
        return hasAnyPermissions(permissions, PERMISSION_DELIMETER) ? StrUtils.EMPTY : NOACCESS;
    }
    ...
    {
        return isRole(role) ? StrUtils.EMPTY : NOACCESS;
    }
    ...
    {
        return isLacksRole(role) ? StrUtils.EMPTY : NOACCESS;
    }
    ...
    {
        return isAnyRoles(roles, ROLE_DELIMETER) ? StrUtils.EMPTY : NOACCESS;
    }
