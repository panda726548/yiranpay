...
public class VelocityUtils
{
    ...
    public static String getFileName(String template, GenTable genTable)
    {
        ...
        {
            fileName = StrUtils.format("{}/{}.html", htmlPath, businessName);
        }
        ...
        {
            fileName = StrUtils.format("{}/tree.html", htmlPath);
        }
        else if (template.contains("add.html.vm"))
        {
            fileName = StrUtils.format("{}/add.html", htmlPath);
        }
        else if (template.contains("edit.html.vm"))
        {
            fileName = StrUtils.format("{}/edit.html", htmlPath);
        }
