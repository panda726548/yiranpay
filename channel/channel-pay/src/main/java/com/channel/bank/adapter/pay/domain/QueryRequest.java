...
public class QueryRequest extends ChannelRequest {
    ...
    /** 原始订单金额(退款时使用) */
    private BigDecimal             originalInstOrderAmount;
    ...
    public BigDecimal getOriginalInstOrderAmount() {
        return originalInstOrderAmount;
    }

    public void setOriginalInstOrderAmount(BigDecimal originalInstOrderAmount) {
