package com.channel.bank.adapter.pay.property;
...
import com.channel.bank.adapter.pay.config.Global;
...
public class DefaultPropertyHelper implements PropertyHelper {
	private Logger             logger = LoggerFactory.getLogger(DefaultPropertyHelper.class);
	 /** 配置文件根路径地址 */
    private String                  configFileRootPath = Global.getPayChannelconfigFilePath();
    /** 配置文件名 */
